...
export const navData = [
  { name: 'Facebook', path: '/', icon: <RiFacebookBoxLine /> },
  { name: 'Github', path: 'https://github.com/Ch1px', icon: <RiGithubLine /> },
  { name: 'Instagram', path: '/services', icon: <RiInstagramLine /> },
  { name: 'LinkedIn', path: '/work', icon: <RiLinkedinLine /> },
  /**{
    name: 'testimonials',
    path: '/testimonials',
